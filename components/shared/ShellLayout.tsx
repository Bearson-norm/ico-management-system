...
export default function ShellLayout({ children }: { children: React.ReactNode }) {
  ...
  const username = (session?.user as { email?: string })?.email || '';
  ...
  const menu = [
    ...(isEditor
      ? [
          ...
          { href: '/mtc/stock-classification', icon: '🔬', label: 'Klasifikasi Stok', section: 'Inventory' },
          ...
          { href: '/mtc/github', icon: '🚀', label: 'GitHub Deploy', section: 'System' },
        ]
