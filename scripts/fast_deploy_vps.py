...
run_cmd('cd /var/www/ico-management-system && ./node_modules/.bin/prisma generate --schema=prisma/mtc/schema.prisma && ./node_modules/.bin/prisma generate --schema=prisma/ga/schema.prisma')
